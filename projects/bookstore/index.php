...
if (!$result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ?>
                ...
                <td>
                    <a href="update_book.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</a>

                </td>
                <td>
                <a href="delete_book.php?id=<?php echo $row['id']; ?>&&title=<?php echo $row['title']; ?>" class="btn btn-danger">Delete</a>
                </td>
                </tr>
                    <?php
}
